...
<div class="admin-container">
    ...
    <div class="admin-header">
        <h1 class="jaune">Ville <span>ajoutée ✓</span></h1>
...
$req = 'INSERT INTO `ville du monde`(villes_nom,villes_pays,villes_population,villes_superficie,
villes_date_fondation,villes_photos,villes_langue) 
VALUES("'.$nom.'","'.$pays.'",'.$population.','.$superficie.',"'.$date_fondation.'","'.$nouvelleImage.'","'.$langue.'")';
echo $req;
